...
module.exports = function (readstorerepository, eventmodels, eventstore, R, _fantasy, uuid, buffer, treis) {
    ...
    return function (event, handlerName, handlerFunction) {
        ...
        var wrapCheckIdempotency = function wrapCheckIdempotency(e) {
            return readstorerepository.checkIdempotency(e.originalPosition, handlerName);
        };
        ...
        var wrapRecordEventProcessed = function wrapRecordEventProcessed(e) {
            return readstorerepository.recordEventProcessed(e.originalPosition, handlerName);
        };
        ...
        var notification = R.curry(function (x, y) {
            var data = {
                result: y,
                message: x,
                initialEvent: event
        ...
        var append = R.curry(function (x) {
            return eventstore.appendToStreamPromise('notification', x);
        });
